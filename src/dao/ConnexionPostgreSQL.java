...
public class ConnexionPostgreSQL {
	...
	public static Connection getInstance()
	{
		...
		try{
			...
			theConnection = DriverManager.getConnection("jdbc:postgresql://" + DonneesConnexion.getAddress() + "/veilletechnologique", DonneesConnexion.getLogin(), DonneesConnexion.getMdp());
		} catch (Exception e) {
